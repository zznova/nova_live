...
class Worker
{
    ...
    protected static function init()
    {
        ...
        if (empty(self::$pidFile)) {
			...
			self::$pidFile = "/uploadfile/websocket/".gethostbyname('nova').'_'. str_replace('/', '_', self::$_startFile) . ".pid";
        }

        // Log file.
        if (empty(self::$logFile)) {
            //self::$logFile = __DIR__ . '/../workerman.log';
			self::$logFile = "/uploadfile/websocket/".gethostbyname('nova')."_workerman.log";
        }
